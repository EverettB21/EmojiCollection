...
class EmojiCollectionViewController: UICollectionViewController {
    ...
    @IBSegueAction func toDetail(_ coder: NSCoder, sender: Any?) -> AddEditEmojiTableViewController? {
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        performSegue(withIdentifier: "toDetail", sender: collectionView.cellForItem(at: indexPath))
    }
    ...
    @IBAction func unwindToEmojiTableView(segue: UIStoryboardSegue) {
        ...
        if let path = collectionView.indexPathsForSelectedItems?.first {
            ...
            let nip = IndexPath(row: emojis.count, section: 0)
            emojis.append(emoji)
